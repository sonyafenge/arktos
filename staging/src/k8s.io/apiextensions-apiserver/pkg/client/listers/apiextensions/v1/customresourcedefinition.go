...
func (s customResourceDefinitionTenantLister) List(selector labels.Selector) (ret []*v1.CustomResourceDefinition, err error) {
...
func (s customResourceDefinitionTenantLister) Get(name string) (*v1.CustomResourceDefinition, error) {
	key := s.tenant + "/" + name
	if s.tenant == "system" {
		key = name
	}
