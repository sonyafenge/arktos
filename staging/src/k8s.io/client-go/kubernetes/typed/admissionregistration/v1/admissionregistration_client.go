...
func NewForConfig(c *rest.Config) (*AdmissionregistrationV1Client, error) {
	...
	obj := &AdmissionregistrationV1Client{
		restClients: clients,
		configs:     configs,
	}
...
func New(c rest.Interface) *AdmissionregistrationV1Client {
	...
	return &AdmissionregistrationV1Client{restClients: clients}
}
...
func (c *AdmissionregistrationV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *AdmissionregistrationV1Client) run() {
	go func(c *AdmissionregistrationV1Client) {
