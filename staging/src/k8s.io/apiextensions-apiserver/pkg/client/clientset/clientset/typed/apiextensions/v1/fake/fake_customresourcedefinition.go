...
func (c *FakeCustomResourceDefinitions) Get(name string, options v1.GetOptions) (result *apiextensionsv1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantGetAction(customresourcedefinitionsResource, name, c.te), &apiextensionsv1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) List(opts v1.ListOptions) (result *apiextensionsv1.CustomResourceDefinitionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantListAction(customresourcedefinitionsResource, customresourcedefinitionsKind, opts, c.te), &apiextensionsv1.CustomResourceDefinitionList{})
...
func (c *FakeCustomResourceDefinitions) Create(customResourceDefinition *apiextensionsv1.CustomResourceDefinition) (result *apiextensionsv1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantCreateAction(customresourcedefinitionsResource, customResourceDefinition, c.te), &apiextensionsv1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) Update(customResourceDefinition *apiextensionsv1.CustomResourceDefinition) (result *apiextensionsv1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateAction(customresourcedefinitionsResource, customResourceDefinition, c.te), &apiextensionsv1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) UpdateStatus(customResourceDefinition *apiextensionsv1.CustomResourceDefinition) (*apiextensionsv1.CustomResourceDefinition, error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantUpdateSubresourceAction(customresourcedefinitionsResource, "status", customResourceDefinition, c.te), &apiextensionsv1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewTenantDeleteAction(customresourcedefinitionsResource, name, c.te), &apiextensionsv1.CustomResourceDefinition{})
...
func (c *FakeCustomResourceDefinitions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *apiextensionsv1.CustomResourceDefinition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewTenantPatchSubresourceAction(customresourcedefinitionsResource, c.te, name, pt, data, subresources...), &apiextensionsv1.CustomResourceDefinition{})
