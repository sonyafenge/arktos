...
func (c *FakeApiextensionsV1) CustomResourceDefinitionsWithMultiTenancy(tenant string) v1.CustomResourceDefinitionInterface {
...
func (c *FakeApiextensionsV1) RESTClients() []rest.Interface {
	var ret *rest.RESTClient
