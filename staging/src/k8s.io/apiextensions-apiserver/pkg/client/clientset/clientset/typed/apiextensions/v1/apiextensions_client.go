...
func (c *ApiextensionsV1Client) CustomResourceDefinitionsWithMultiTenancy(tenant string) CustomResourceDefinitionInterface {
...
func New(c rest.Interface) *ApiextensionsV1Client {
	...
	return &ApiextensionsV1Client{restClients: clients}
}
...
func (c *ApiextensionsV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *ApiextensionsV1Client) run() {
	go func(c *ApiextensionsV1Client) {
